(function () {
  ...
  var Asyncify = require(__dirname + "futures/asyncify"),
    onceOnlySync,
    onceOnly,
    future;
...
(function () {
  ...
  var Futures = require(__dirname + 'futures');
...
(function () {
  ...
  var Loop = require(__dirname + "futures/loop"),
    loop = Loop();
...
(function () {
  ...
  var Promise = require(__dirname + "futures/future"),
    promise = Promise();
...
(function () {
  ...
  var Sequence  = require(__dirname + "futures/sequence"),
    sequence = Sequence(),
    err = undefined;
...
(function () {
  ...
  var Emitter = require(__dirname + "futures/emitter"),
    emitter = Emitter();
...
(function () {
  ...
  var Synchronize = require(__dirname + "futures/join"),
    Future = require(__dirname + "futures/future"),
...
(function () {
  ...
  var Chainify = require(__dirname + "futures/chainify"),
    model,
    providers,
    modifiers,
    consumers;
...
(function () {
  ...
  var Future = require(__dirname + "futures/future"),
    global_context = {
      color: 'yellow'
    },
    context = {
