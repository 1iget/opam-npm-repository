...
Parser.prototype.write = function(buffer) {
  ...
  for (; i < length; i++) {
    ...
    switch (state) {
      ...
      case Parser.FIELD_CATALOG_LENGTH:
        if (packet.index == 0) {
          if (c === 0xfe) {
        ...
        break;
      case Parser.FIELD_CATALOG_STRING:
        if (packet.index == 0) {
          packet.catalog = '';
        }
        ...
        break;
      case Parser.FIELD_DB_LENGTH:
        self._lengthCodedStringLength = lengthCoded(self._lengthCodedStringLength);
        break;
      case Parser.FIELD_DB_STRING:
        if (packet.index == 0) {
          packet.db = '';
        }
        ...
        break;
      case Parser.FIELD_TABLE_LENGTH:
        self._lengthCodedStringLength = lengthCoded(self._lengthCodedStringLength);
        break;
      case Parser.FIELD_TABLE_STRING:
        if (packet.index == 0) {
          packet.table = '';
        }
        ...
        break;
      case Parser.FIELD_ORIGINAL_TABLE_LENGTH:
        self._lengthCodedStringLength = lengthCoded(self._lengthCodedStringLength);
        break;
      case Parser.FIELD_ORIGINAL_TABLE_STRING:
        if (packet.index == 0) {
        ...
        break;
      case Parser.FIELD_NAME_LENGTH:
        self._lengthCodedStringLength = lengthCoded(self._lengthCodedStringLength);
        break;
      case Parser.FIELD_NAME_STRING:
        if (packet.index == 0) {
          packet.name = '';
        }
        ...
        break;
      case Parser.FIELD_ORIGINAL_NAME_LENGTH:
        self._lengthCodedStringLength = lengthCoded(self._lengthCodedStringLength);
        break;
      case Parser.FIELD_ORIGINAL_NAME_STRING:
        if (packet.index == 0) {
          packet.originalName = '';
        }
        ...
        break;
      case Parser.FIELD_FILLER_1:
        // 1 bytes - 0x00
        advance();
        break;
      case Parser.FIELD_CHARSET_NR:
        if (packet.index == 0) {
      ...
      case Parser.FIELD_LENGTH:
        ...
        break;
      case Parser.FIELD_TYPE:
        // 1 byte
        packet.fieldType = c;
        advance();
      case Parser.FIELD_FLAGS:
        if (packet.index == 0) {
          packet.flags = 0;
        }
        ...
        break;
      case Parser.FIELD_DECIMALS:
        // 1 byte
        packet.decimals = c;
        advance();
        break;
      case Parser.FIELD_FILLER_2:
        // 2 bytes - 0x00
        if (packet.index == 1) {
          advance();
        }
        break;
      case Parser.FIELD_DEFAULT:
        // TODO: Only occurs for mysql_list_fields()
        break;

      // EOF_PACKET
      case Parser.EOF_WARNING_COUNT:
        if (packet.index == 0) {
      ...
      case Parser.EOF_SERVER_STATUS:
        ...
        break;
      case Parser.COLUMN_VALUE_LENGTH:
        if (packet.index == 0) {
